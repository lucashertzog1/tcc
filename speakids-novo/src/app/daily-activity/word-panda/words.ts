// This file is kept for word validation purposes, but not for generating the word of the day anymore.
export const fiveLetterWords = [
    ...
    'email', 'empty', 'entry', 'equal', 'event', 'exact', 'extra', 'faith',
    'fault', 'field', 'fight', 'final', 'floor', 'focus', 'force', 'frame',
    'frank', 'front', 'fruit', 'glass', 'grant', 'grass', 'green', 'group',
    'guide', 'guard', 'guest', 'heart', 'heavy', 'hence', 'horse', 'hotel',
    'house', 'human', 'ideal', 'image', 'index', 'inner', 'input', 'issue',
    'joint', 'jones', 'judge', 'knife', 'knock', 'label', 'labor', 'large',
    'laugh', 'layer', 'learn', 'leave', 'legal', 'level', 'lewis', 'light',
    'limit', 'link', 'local', 'logic', 'loose', 'lunch', 'lying', 'magic',
    ...
    'print', 'prior', 'prize', 'proof', 'proud', 'prove', 'queen', 'quest',
    'quick', 'quiet', 'quite', 'radio', 'raise', 'range', 'rapid', 'ratio',
    'reach', 'react', 'ready', 'refer', 'right', 'rival', 'river', 'robin',
