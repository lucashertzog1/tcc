  ...
  return (
    <div className="flex flex-col gap-8 py-8 items-center">
       <div className="space-y-2 text-center">
        <h1 className="text-3xl md:text-4xl font-bold font-headline text-white drop-shadow-lg">Reading Practice</h1>
        <p className="text-white/90 drop-shadow-md">Read a new story and click on any word to see its translation.</p>
      </div>
